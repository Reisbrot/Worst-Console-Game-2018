...
public class Einbecker-Bierdeckel implements Item{
    String name = \u0022Einbecker-Bierdeckel\u0022;
    int weight = 5; //in Gramm
    int hardness = 4; //Mohs
    Smell smell = new Smell(0);
    String phase = \u0022solid\u0022; //liquid, gas
    String description = \u0022Das Einbecker-Logo, umgeben von Zacken!\u0022;
